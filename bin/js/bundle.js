    ...
    onOpened(d) {
      ...
      switch (d.type) {
        ...
        case 2:
          ...
          this.stealGet.getChildByName("top_lb").text = "\u4F60\u6F5C\u5165\u4E86xx\u7684\u83DC\u5730\uFF0C\u5077\u8D70\u4E86\uFF1A";
          this.updateDescList();
          break;
        case 3:
          this.stealGet.visible = true;
